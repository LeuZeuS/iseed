**This is another fork of https://github.com/cheesegrits/iseed (fork of [orangehill/iseed](https://github.com/orangehill/iseed) with updated few things and added iseed:all command)
